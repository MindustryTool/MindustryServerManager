...
COPY --chown=gradle:gradle gradlew gradlew.bat settings.gradle.kt build.gradle.kt gradle.properties /home/gradle/src/
COPY --chown=gradle:gradle dto/build.gradle /home/gradle/src/dto/build.gradle
COPY --chown=gradle:gradle plugin/build.gradle.kt plugin/gradle.properties /home/gradle/src/plugin/
COPY --chown=gradle:gradle server/build.gradle.kt /home/gradle/src/server/build.gradle.kt
