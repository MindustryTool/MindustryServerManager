...
public class CataliConfig {
    ...
    private List<UnitExpEntry> _getUnitExp() {
        ...
        unitExp.add(new UnitExpEntry(disrupt, 1600));
        return unitExp;
    }
    ...
    private List<UnitRespawnTimeEntry> _getUnitRespawnTime() {
        ...
        unitRespawnTime.add(new UnitRespawnTimeEntry(mace, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(pulsar, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(atrax, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(horizon, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(minke, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(oxynoe, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(locus, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(cleroi, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(avert, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(fortress, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(quasar, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(spiroct, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(zenith, Duration.ofSeconds(80)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(mega, Duration.ofSeconds(60)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(bryde, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(cyerce, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(precept, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(anthicus, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(obviate, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(scepter, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(vela, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(arkyid, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(antumbra, Duration.ofSeconds(100)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(quad, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(sei, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(aegires, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(vanquish, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(tecta, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(quell, Duration.ofSeconds(120)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(reign, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(corvus, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(toxopid, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(eclipse, Duration.ofSeconds(160)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(oct, Duration.ofSeconds(140)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(omura, Duration.ofSeconds(200)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(navanax, Duration.ofSeconds(200)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(conquer, Duration.ofSeconds(200)));
        unitRespawnTime.add(new UnitRespawnTimeEntry(collaris, Duration.ofSeconds(200)));
    ...
    private List<BlockExpEntry> _getBlockExp() {
        ...
        blockExp.add(new BlockExpEntry(phaseWallLarge, 160));
