...
public class SessionService {
    ...
    public void update(Session session) {
        ...
        // Using existing logic for compatibility: calculating exp based on session play time
        ...
        if (level != session.currentLevel) {
            ...
            // Ideally UI updates should be separate, but name update is part of the state sync here
